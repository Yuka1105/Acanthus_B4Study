void draw(){
  ...
  //noStroke();
  //fill(255,100,0);
  //ellipse(sbXl,sbYl,12,12);
  //fill(100,100,180);
  //ellipse(sbXl,sbYl,8,8);
  //fill(255,100,0);
  //ellipse(a,sbYl,8,8);
  //ellipse(b,sbYr,8,8);
  //ellipse(sbXr,sbYr,12,12);
  //fill(100,100,180);
  //ellipse(sbXr,sbYr,8,8);
  //noFill();
